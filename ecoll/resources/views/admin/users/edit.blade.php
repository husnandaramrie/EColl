					...
					<div class="form-group">
						...
						<select name="levels" id="" class="form-control">
                            @foreach ($levels as $item)
                                <option value="{{$item['levelid']}}" {{$data[0]['level'] == $item['levelid'] ? 'selected' : ''}}>{{$item['levelname']}}</option>
                            @endforeach
                        </select>
					</div>
					<div class="form-group">
						...
						<select name="cluster" id="" class="form-control">
                            @foreach ($clusters as $item)
                                <option value="{{$item['clusterid']}}" {{$data[0]['cluster'] == $item['clusterid'] ? 'selected' : ''}}>{{$item['clustername']}}</option>
                            @endforeach
                        </select>
					</div>
					<div class="form-group">
						...
						<select name="client" id="" class="form-control">
                            @foreach ($clients as $item)
                                <option value="{{$item['clientid']}}" {{$data[0]['client'] == $item['clientid'] ? 'selected' : ''}}>{{$item['clientname']}}</option>
                            @endforeach
                        </select>
					</div>
                    <div class="form-group">
						...
						<select name="cabang" id="" class="form-control">
                            @foreach ($branches as $item)
                                <option value="{{$item['clientid']}}" {{$data[0]['cabang'] == $item['clientid'] ? 'selected' : ''}}>{{$item['clientname']}}</option>
                            @endforeach
                        </select>
					</div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <ul>
                            <li>
                                ...
                                <input type="checkbox" {{$data[0]['transsetoran'] ? 'checked' : ''}} name="setoran" id="">
                            </li>
                            <li>
                                <label for="">Penarikan</label>
                                <input type="checkbox" {{$data[0]['transpenarikan'] ? 'checked' : ''}} name="penarikan" id="">
                            </li>
                            <li>
                                <label for="">Angsuran Kredit</label>
                                <input type="checkbox" {{$data[0]['transanggsuran'] ? 'checked' : ''}} name="angsuran_kredit" id="">
                            </li>
                        </ul>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="relasi_mbs_online" id="" class="form-control">
                            @foreach ($relations as $item)
                                <option value="{{$item['userid']}}" {{$data[0]['corebankid'] == $item['userid'] ? 'selected' : ''}}>{{$item['username']}}</option>
                            @endforeach
                        </select>
                    </div>
					<div class="form-group">
