...
Route::group(['prefix' => 'admin','middleware' => ['admin']],function(){
	Route::name('admin.')->group(function(){
        ...
        Route::get('/pintransaksi/destroyPin/{id}', [PinTransaksiController::class, 'destroyPin'])->name('pintransaksi.destroyPin');
		...
		Route::post('/rekap/addView', [RekapController::class, 'addview'])->name('rekap.addView');

        route::get('/cek_tr_ganda', [CekTrGandaController::class, 'indexCekTransGan'])->name('cek_tr_ganda');
