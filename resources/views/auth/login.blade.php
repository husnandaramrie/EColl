...
<div class="login-box mb-5">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="" class="h4"><b>ECollection</a>
    </div>
    <div class="card-body">
      ...
      <form action="{{ route('login_api') }}" method="post">
        ...
        <div class="input-group mb-3">
          <input value="{{ @old('email') }}" name="username" type="text" class="form-control @error('email') is-invalid @enderror" placeholder="Email">
